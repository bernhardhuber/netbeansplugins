 ...
 * @author HuberB1
 */
public class GzipCompressOperationTest extends AbstractFileSystemOperationTestCase {
    private FileObject aFileObject;
    private final String sampleFileName;
    
    public GzipCompressOperationTest(String testName) throws Exception {
        super(testName);
        this.sampleFileName = "sampleFileForGzipCompressOperationTest" ;
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(GzipCompressOperationTest.class);
        
        return suite;
    }
    
    /**
     * Test of compress method, of class org.huberb.nbgzip.operation.GzipCompressOperation.
     */
    public void testCompress() throws IOException {
        ...
        final FileObject compressedFO = this.getFileSystem().getRoot().getFileObject(sampleFileName + ".gz" );
        ...
        final FileObject uncompressedFO = this.getFileSystem().getRoot().getFileObject(sampleFileName  );
