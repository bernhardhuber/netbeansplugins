...
final class LocaleTopComponent extends TopComponent {
    ...
    private LocaleOptionPropertyChangeListener localeOptionPropertyChangeListener;
    public void componentOpened() {
        ...
        localeOptionPropertyChangeListener = new LocaleOptionPropertyChangeListener( this.formatCommands );
        localeOption.addPropertyChangeListener(this.localeOptionPropertyChangeListener);
    }
    
    public void componentClosed() {
        LocaleOption.getDefault().removePropertyChangeListener(this.localeOptionPropertyChangeListener);
    }
     ...
     *   <code>HelpTextCommandInterface</code> the appropriate help text is displayed
     * </p>
