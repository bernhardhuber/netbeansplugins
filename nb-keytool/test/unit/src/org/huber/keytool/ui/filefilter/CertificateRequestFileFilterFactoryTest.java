 ...
 * @author HuberB1
 */
public class CertificateRequestFileFilterFactoryTest extends TestCase {
    
    public CertificateRequestFileFilterFactoryTest(String testName) {
        super(testName);
    }
    
    /**
     * Test of addChoosableFileFilter method, of class org.huber.keytool.ui.filefilter.CertificateRequestFileFilterFactory.
     */
