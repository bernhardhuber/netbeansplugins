...
public class RegexpPanel extends javax.swing.JPanel {
     ...
     *
     * @return int a value or by the <code>Pattern</code> flags, like <code>Pattern.CASE_INSENSITIVE</code>
     */
     ...
     *
     * @param matcher inspect the matcher's props for build the result string
     * @param matchesResult the matcher's result
     * @return StringBuffer the matcher's result as an human readable result string
     */
